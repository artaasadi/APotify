...
public class Player {
     ...
     */
    public Player(InputStream stream) throws JavaLayerException, IOException {
        this(stream, null);
    }

    public Player(InputStream stream, AudioDevice device) throws JavaLayerException, IOException {
